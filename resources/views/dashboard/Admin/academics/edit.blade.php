...
@section('content')
    ...
    <div class="card">
        <form class="form" method="POST" action="{{ route('admin.academics.update',$academic->id) }}">
            @method('put')
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-list">
                        <label class="checkbox">
                            ...
                            {{ old('status', isset($academic->status))  ? 'checked' : '' }} />
                            <span></span>
                            Active
                        </label>
                        <label class="checkbox">
