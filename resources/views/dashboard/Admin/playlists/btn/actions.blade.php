<div class="d-flex">
    ...
    @if ($playlist->deleted_at == null)
        <button class="btn btn-danger mx-1" onclick="confirmDeleteAdmin({{ $playlist->id }})">{{ trans('dashboard/general.delete')}}</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteAdminModalLabel">Delete Playlist</h5>
